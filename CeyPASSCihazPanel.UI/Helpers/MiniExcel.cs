...
namespace CeyPASSCihazPanel.UI.Helpers
{
...
<workbook xmlns=""http://schemas.openxmlformats.org/spreadsheetml/2006/main"" xmlns:r=""http://schemas.openxmlformats.org/officeDocument/2006/relationships"">
  <sheets>
    <sheet name=""Sheet1"" sheetId=""1"" r:id=""rId1""/>
        ...
        {
            // Minimal styles to avoid errors
            return @"<?xml version=""1.0"" encoding=""UTF-8"" standalone=""yes""?>
  ...
  <cellXfs count=""1"">
    <xf numFmtId=""0"" fontId=""0"" fillId=""0"" borderId=""0"" xfId=""0""/>
        ...
        private static string GetSheetXml(DataTable dt)
        {
            ...
            // Header Row
            sb.Append(@"<row r=""1"">"); // 1-based index
            int colIndex = 1;
            ...
            // Data Rows
            int rowIndex = 2; // Data starts at row 2
            foreach (DataRow row in dt.Rows)
            {
                ...
                foreach (var item in row.ItemArray)
                {
                    ...
                    // Use inlineStr (t="inlineStr") to avoid sharedStrings table complexity
